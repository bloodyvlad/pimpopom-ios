...
## TestFlight build-24 current copy

**Beta App Description**

PimPoPom is a reaction game with Arcade, Zen, and a 2–4-player Multiplayer beta.
Build 24 keeps immediate local Multiplayer tap feedback while ordinary network
...
Results. Build 24 must stop mixed live-wire rooms with Update Required before Start.
