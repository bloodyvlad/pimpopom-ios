...
The internal alpha resolves Google Sign-In through Swift Package Manager. Exact revisions are pinned in `PimPoPom.xcodeproj/project.xcworkspace/xcshareddata/swiftpm/Package.resolved`.
