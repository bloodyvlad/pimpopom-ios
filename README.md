...
- Simulator regression evidence: implementation commit `bf73ecd` passed 29 core tests, 37 native unit tests, and all 17 iPhone SE 2022 XCUITest paths on iOS 26.5. Direct SE inspection covered the final Light menu, detailed Leaderboard/Profile/Game Over surfaces, and Pet Shop placement; an exact-commit Light-menu capture is retained. The earlier 13 mini/13 Pro regression remains recorded at commit `ec71d21` and was not rerun for this batch. The current checkpoint was not installed or tested on physical hardware.
