...
- Themes and pets: four code-native visual themes plus reviewed current Foka/Kesha/Tauta/Misha/Mitsuri sprite sheets and server-derived Muse special-pet art. Menu/gameplay placement and Pet Shop habitat/static-preview behavior follow the parent web repository at commit `7582b2d`. Pancake remains a labelled code-native placeholder and cannot be newly purchased until replacement art is approved.
...
- Simulator regression evidence: implementation commit `3b022c3` passed 29 core tests, 26 native unit tests, and nine iPhone SE 2022 XCUITest paths on iOS 26.5. Captured states cover menu and gameplay Muse presentation, Pet Shop habitat/static-preview placement, and a decreasing Arcade response bar. This checkpoint was not installed or tested on physical hardware.
