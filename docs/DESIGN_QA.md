...
Build `1.01 (5)` from exact implementation commit `4805976` is processed as VALID in TestFlight and assigned to Internal QA. It adds focused automated owner/non-owner ad-route evidence and a compiled Pixel HUD correction; neither has been visually accepted from the TestFlight build. The earlier responsive AdMob/UMP fake-layout evidence remains at `f4f9be4`, density-aware glyph/feedback evidence at `bfbc351`, and the latest structured historical physical-install checkpoint at `bab0709`. Prior Disco/footer evidence remains at `6743fc2`, Leaderboard/gameplay evidence at `c0bcc69`, and icon/quick-action evidence at `30503e3`. The current complete 13 mini/13 Pro matrix, TestFlight install, Sandbox purchase, consent/revocation, production-unit interstitial, accidental-tap review, and 60/120 Hz timing still require physical validation.
