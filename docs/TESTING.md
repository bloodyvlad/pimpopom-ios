...
- **Unit-tested:** 29 pure Swift checks cover scoring/rounding, phase/grid boundaries, lives/recovery, proof timing/order, deadline equality, multiplier overflow/reset/5× accounting, decoy overlap/expiry/reservation/ignored opportunities, reset behavior, and Zen retention/cadence/manual results. Fifty native app tests additionally cover cosmetics and API contracts, audio lifecycle, persisted Glyphs/motivation state, the exact 26-slogan pool and deterministic 10-second rotation, canonical smooth/pixel glyph bounds at every supported size, Light/Pixel/Disco material tokens, clipped/cached Pixel composition, per-surface pet geometry, shared menu/shop/gameplay tap zones, board-gap presentation routing, staged wake/turn plans, Pancake offsets/mirroring/resources, opaque utility badge composition, structured Perfect/Godlike stamp events, profile/rank fixtures, ranked proof payloads, response progress, and StoreKit-placeholder safety.
- **Simulator-tested:** all 18 XCUITest paths pass on the named iPhone SE (3rd generation, 2022) Simulator with iOS 26.5 at implementation commit `a607adc`. Coverage includes Arcade/Zen, fixed non-scrolling menu geometry, signed-in menu rank, illuminated slogan placement, near-full-width gameplay, response-bar drain, gameplay pet placement and left/right following, glyph hiding, menu-pet sleep/wake and left/right following, direct whole-tile Theme actions, Pet Shop, Pancake menu/Leaderboard presentation, static-until-tapped previews, select/hide/show, clean live Leaderboard/Profile/results surfaces, the Game Center placeholder, settings, Buy Coins, and Remove Ads. The fixtures are local and prevent production network mutations. The earlier 15 device-independent paths passed independently on iPhone 13 mini and iPhone 13 Pro at implementation commit `ec71d21`; those profiles were not rerun for the current batch.
- **Simulator-inspected:** implementation commit `a607adc` was directly inspected on the SE profile for the opaque corner coin badge; vivid scratched/backlit Disco target; Light crystal cell and matching Your Color swatch; Pixel clipped grain, full-size pixel glyph, and matching preview; Pancake's lowered menu/Leaderboard composition; and clean mirrored full-left/direct full-right menu following. No new screenshot was retained. Earlier exact-commit evidence remains recorded below, including three-profile captures at `ec71d21`. Parent web commits `923a38e`, `7582b2d`, and `209ee6c` remain the menu/theme, pet, and latest PHP visual references respectively.
...
- **Not yet validated:** physical install or structured physical visual/listening/touch review of implementation commit `a607adc`, measured 60/120 Hz touch timing, real Google iOS OAuth and signed-in shop/ranked mutations, Game Center integration, accessibility matrix, audio balance/routes/interruptions/Silent switch, haptics, live ads, and StoreKit.
...
The current no-new-capture evidence for implementation commit `a607adc9db0ee9da39b49e47b41b6ee08fd0099f`, plus retained iOS 26.5 screenshots, hashes, configurations, and limitations for earlier commits, is recorded in [`DESIGN_QA.md`](DESIGN_QA.md).
