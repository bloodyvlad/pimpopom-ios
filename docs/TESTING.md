...
- **Unit-tested:** 29 pure Swift checks cover scoring/rounding, phase/grid boundaries, lives/recovery, proof timing/order, deadline equality, multiplier overflow/reset/5× accounting, decoy overlap/expiry/reservation/ignored opportunities, reset behavior, and Zen retention/cadence/manual results. Thirty-seven native app tests additionally cover cosmetics and API contracts, audio lifecycle, persisted Glyphs/motivation state, the exact 26-slogan pool and deterministic 10-second rotation, Light/Pixel tokens, per-surface pet geometry, staged wake/30-degree turn plans, Pancake resources, structured Perfect/Godlike stamp events, border-lane placement, profile fixtures, SpriteKit glyph removal, response-progress drain/clamping, and StoreKit-placeholder safety.
- **Simulator-tested:** all 17 XCUITest paths pass on the named iPhone SE (3rd generation, 2022) Simulator with iOS 26.5. Coverage includes Arcade/Zen, fixed non-scrolling menu geometry, illuminated slogan placement, near-full-width gameplay, response-bar drain, gameplay pet placement, glyph hiding, menu-pet sleep/wake, Theme/Pet shops, normal Pancake presentation, static-until-tapped previews, select/hide/show, detailed Leaderboard/Profile/results surfaces, settings, Buy Coins, and Remove Ads. The fixtures are local and prevent production network mutations. The earlier 15 device-independent paths passed independently on iPhone 13 mini and iPhone 13 Pro at implementation commit `ec71d21`; those profiles were not rerun for the current batch.
- **Simulator-inspected:** implementation commit `bf73ecd` was directly inspected on the SE profile for the fixed Light menu and illuminated slogan, Light-only logo plate, public Leaderboard, signed-out and fixture-backed signed-in Profile, Pet Shop placement, and Game Over hierarchy. A retained exact-commit capture records the final Light menu. Earlier commit `ec71d21` retains Light/Pixel menu and gameplay captures across SE, 13 mini, and 13 Pro. Parent web commits `923a38e`, `7582b2d`, and `209ee6c` are the menu/theme, pet, and latest PHP visual references respectively.
...
- **Not yet validated:** physical install or structured physical visual/listening/touch review of implementation commit `bf73ecd`, measured 60/120 Hz touch timing, real Google iOS OAuth and signed-in shop/ranked mutations, accessibility matrix, audio balance/routes/interruptions/Silent switch, haptics, live ads, and StoreKit.
...
The retained iOS 26.5 screenshots, hashes, configurations, and limitations for implementation commits `bf73ecd0ec62a8862aea253ece3410f01509173a` and `ec71d2169c45c7b1f3ca4d7f0434aa48d36a0314`, together with earlier checkpoints, are recorded in [`DESIGN_QA.md`](DESIGN_QA.md).
