...
## Current alpha evidence — 2026-07-17

- **Unit-tested:** 29 pure Swift checks cover scoring/rounding, phase/grid boundaries, lives/recovery, proof timing/order, deadline equality, multiplier overflow/reset/5× accounting, decoy overlap/expiry/reservation/ignored opportunities, reset behavior, and Zen retention/cadence/manual results. Forty native app tests additionally cover cosmetics and API contracts, audio lifecycle, persisted Glyphs/motivation state, the exact 26-slogan pool and deterministic 10-second rotation, Light/Pixel/Disco-preview tokens, per-surface pet geometry, staged wake and horizontal 15%-width turn plans, Pancake resources, structured Perfect/Godlike stamp events, hidden duplicate hit feedback, border-lane placement, profile/rank fixtures, ranked start/finish proof payloads, SpriteKit glyph removal, response-progress drain/clamping, and StoreKit-placeholder safety.
- **Simulator-tested:** all 17 XCUITest paths pass on the named iPhone SE (3rd generation, 2022) Simulator with iOS 26.5 at implementation commit `cccdae2`. Coverage includes Arcade/Zen, fixed non-scrolling menu geometry, signed-in menu rank, illuminated slogan placement, near-full-width gameplay, response-bar drain, gameplay pet placement, glyph hiding, menu-pet sleep/wake, direct whole-tile Theme actions, Pet Shop, normal Pancake presentation, static-until-tapped previews, select/hide/show, clean live Leaderboard/Profile/results surfaces, the Game Center placeholder, settings, Buy Coins, and Remove Ads. The fixtures are local and prevent production network mutations. The earlier 15 device-independent paths passed independently on iPhone 13 mini and iPhone 13 Pro at implementation commit `ec71d21`; those profiles were not rerun for the current batch.
- **Simulator-inspected:** implementation commit `cccdae2` was directly inspected on the SE profile during its final implementation pass for the revised menu utilities, exact coin/rank badges, leading shop icons, 10%-shifted slogan, direct-action Theme Shop with black Disco preview, live public Leaderboard with stacked rank/pet, signed-out Profile/Game Center placeholder, centered gameplay glyph, clean Game Over, and Pet Shop placement. No new screenshot was retained. Earlier commit `bf73ecd` retains an exact-commit Light-menu capture; commit `ec71d21` retains Light/Pixel menu and gameplay captures across SE, 13 mini, and 13 Pro. Parent web commits `923a38e`, `7582b2d`, and `209ee6c` are the menu/theme, pet, and latest PHP visual references respectively.
...
- **Asset-tested:** 65 retained runtime/master/source/licence files pass committed SHA-256 checks; runtime audio format/duration, all approved pet sheet/habitat dimensions, Pancake runtime/source/chroma/alpha retention, Disco texture dimensions/copies, and Jersey 10 registration/copy are validated.
- **Live read-tested:** Hostinger health, signed-out session bootstrap, and public Arcade leaderboard returned successfully; the revised in-app Leaderboard decoded and rendered 30 live Arcade results. The automatic ranked finish path is contract-tested without mutating production. No authenticated score, shop, profile, or economy write was performed during this checkpoint.
- **Physical install checkpoints:** commit `d3ffd87958d1eba4ca175b2e0590c1b234063072` was development-signed with team `APX2925X66`, installed, and launched successfully through CoreDevice on the owner's wired iPhone SE (3rd generation) with iOS 26.3. Per owner request, no automated or structured visual/touch/listening retest was run for that checkpoint. Earlier install/launch checkpoints `fd34cf4c3d854486c236aa9edcca9c721495804f` and `54bd3720d22e42dfd88dc8c1ef7d660f63a6ae7a` remain historical evidence.
- **Not yet validated:** physical install or structured physical visual/listening/touch review of implementation commit `cccdae2`, measured 60/120 Hz touch timing, real Google iOS OAuth and signed-in shop/ranked mutations, Game Center integration, accessibility matrix, audio balance/routes/interruptions/Silent switch, haptics, live ads, and StoreKit.
...
The current no-new-capture evidence for implementation commit `cccdae2ca5179213b34d6adf6f16466d7c18ba64`, plus retained iOS 26.5 screenshots, hashes, configurations, and limitations for commits `bf73ecd0ec62a8862aea253ece3410f01509173a` and `ec71d2169c45c7b1f3ca4d7f0434aa48d36a0314`, are recorded in [`DESIGN_QA.md`](DESIGN_QA.md).
