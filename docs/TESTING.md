...
- **Not yet validated:** physical launch/listening/touch review of the current cosmetics/audio slice, measured 60/120 Hz touch timing, real Google iOS OAuth and signed-in shop/ranked mutations, accessibility matrix, audio routes/interruptions/Silent switch, haptics, live ads, and StoreKit.
